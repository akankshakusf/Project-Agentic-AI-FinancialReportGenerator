...
# Companies to generate report for 
...
user_proxy_auto = autogen.UserProxyAgent(
    ...
    code_execution_config={
        "last_n_messages": 3, #all agents can review upto 3 past comments
        "work_dir": "coding",
        "use_docker": False,
    },  
)

#chat results structure and storage
